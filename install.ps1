...
.PARAMETER Ref
    Workflow git ref to pin, such as v0.3.2 or a full commit SHA (default: v0.3.2)
.PARAMETER Threshold
...
.EXAMPLE
    ./install.ps1 -Ref "v0.3.2" -Languages "javascript-typescript,python" -Threshold "HIGH"
#>
param(
    [string]$Ref = "v0.3.2",
