...
# usage: curl -sL https://raw.githubusercontent.com/codywilliamson/repo-sentinel/v0.3.0/install.sh | bash
# or:    ./install.sh [--ref "v0.3.0"] [--languages "javascript-typescript,python"] [--threshold "MEDIUM"] [--no-copilot]
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --help|-h)
      ...
      echo ""
      echo "options:"
      echo "  --ref <git-ref>       Workflow ref to pin (default: v0.3.0)"
